...
def decompress_dynamic(input: memoryview) -> memoryview:
    return fastlzpy.fastlz_compress_dynamic(input)

def decompress(input: memoryview, output: memoryview):
    return fastlzpy.fastlz_decompress(input, len(input), output, len(output))
